...
<img alt="Layout" src="https://i.imgur.com/ZCH4WuV.png">
<br>


## :house: About the project

New facebook registration login.Project built with HTML5 and CSS .🚀 <br>
The site contains a design similar to the Facebook home page, same appearance styling and componentized cadastre registration.

Technologies used: VScode , Vercel, HTML Semantic, Google Fonts, Registry Components.
<br>
...
Link: (https://new-meta-olive.vercel.app/)
<br>
